...
\begin{document}
  ...
  \subsection{Results and Dicussion}
    ...
    \subsubsection{Wiring Harness}
      ...
      The only custom components remaining on the copter are the power supplies, interlink cables, and a GPIO breakout board for the Raspberry pi.  We are very confident that this project can be fully replicated by any motivated hobbyist.
