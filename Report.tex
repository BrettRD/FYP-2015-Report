...
\begin{document}
  ...
  %describe the hardware in detail.
    \subsection{Introduction}
      ...
      At almost every stage of this fifth order dynamic system, the flight mechanics introduce perturbations to any additional control scheme with a particular intent.
      ...
      In order to support the object tracker
